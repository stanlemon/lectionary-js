...
export class ThreeYearWeek {
    ...
    getWeek() {
        ...
        const epiphany = toInternalDayjs(year.getEpiphany(), "ThreeYear.getEpiphany()");
        const epiphanySunday = toInternalDayjs(year.getEpiphanySunday(), "ThreeYear.getEpiphanySunday()");
        const transfiguration = toInternalDayjs(year.getTransfiguration(), "ThreeYear.getTransfiguration()");
        ...
        const trinitySunday = toInternalDayjs(year.getPentecost(), "ThreeYear.getPentecost()").add(1, "week");
