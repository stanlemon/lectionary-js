...
describe("ThreeYearWeek — Advent", () => {
  ...
  it("Advent 1 2025 (Nov 30)", () =>
    expect(week("11/30/2025")).toBe(Sundays.ADVENT_1));
  it("Advent 2 2025 (Dec 7)", () =>
    expect(week("12/07/2025")).toBe(Sundays.ADVENT_2));
  it("Advent 4 2025 (Dec 21)", () =>
    expect(week("12/21/2025")).toBe(Sundays.ADVENT_4));
});
...
describe("ThreeYearWeek — Epiphany season", () => {
  ...
  it("Epiphany 2 2026 (Jan 18)", () =>
    expect(week("01/18/2026")).toBe(Sundays.EPIPHANY_2));
  it("Epiphany 3 2026 (Jan 25)", () =>
    expect(week("01/25/2026")).toBe(Sundays.EPIPHANY_3));
  it("Epiphany 4 2026 (Feb 1)", () =>
    expect(week("02/01/2026")).toBe(Sundays.EPIPHANY_4));
  it("Epiphany 5 2026 (Feb 8)", () =>
    expect(week("02/08/2026")).toBe(Sundays.EPIPHANY_5));
...
describe("ThreeYearWeek — Lent through Trinity Sunday", () => {
  ...
  it("Lent 1 2026 (Feb 22)", () =>
    expect(week("02/22/2026")).toBe(Sundays.LENT_1));
  it("Lent 2 2026 (Mar 1)", () =>
    expect(week("03/01/2026")).toBe(Sundays.LENT_2));
  it("Lent 5 2026 (Mar 22)", () =>
    expect(week("03/22/2026")).toBe(Sundays.LENT_5));
  it("Palm Sunday 2026 (Mar 29)", () =>
    expect(week("03/29/2026")).toBe(Sundays.PALM_SUNDAY));
  it("Easter 2026 (Apr 5)", () =>
    expect(week("04/05/2026")).toBe(Sundays.EASTER));
  it("Easter 2 2026 (Apr 12)", () =>
    expect(week("04/12/2026")).toBe(Sundays.EASTER_2));
  // Pentecost 2026 = May 24 (Easter + 7 weeks)
  it("Pentecost 2026 (May 24)", () =>
    expect(week("05/24/2026")).toBe(Sundays.PENTECOST));
...
describe("ThreeYearWeek — Ordinary Time (Propers)", () => {
  ...
  it("Proper 5 2026 (Jun 7)", () =>
    expect(week("06/07/2026")).toBe(Sundays.PROPER_5));
  it("Proper 6 2026 (Jun 14)", () =>
    expect(week("06/14/2026")).toBe(Sundays.PROPER_6));
  it("Proper 10 2026 (Jul 12)", () =>
    expect(week("07/12/2026")).toBe(Sundays.PROPER_10));
  it("Proper 20 2026 (Sep 20)", () =>
    expect(week("09/20/2026")).toBe(Sundays.PROPER_20));

  // Proper 29 (Christ the King): Nov 20-26. Proper 29 = week 84.
  it("Proper 29 2026 (Nov 22)", () =>
    expect(week("11/22/2026")).toBe(Sundays.PROPER_29));

  // Early-Easter year: Easter Mar 27 2016, Trinity = May 22
  // First Ordinary Time Sunday = May 29 → Proper 4 (05-29 to 06-04) → week 59
  it("Proper 4 2016 (May 29)", () =>
    expect(week("05/29/2016")).toBe(Sundays.PROPER_4));

  // Very early Easter: Easter Mar 23 2008, Trinity = May 18
  // First Ordinary Time Sunday = May 25 → Proper 3 (05-24 to 05-28) → week 58
  it("Proper 3 2008 (May 25)", () =>
    expect(week("05/25/2008")).toBe(Sundays.PROPER_3));
});
