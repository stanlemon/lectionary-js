...
describe("KeyLoader", () => {
  ...
  it("matches propers by month and day for calendar feast days", () => {
    const proper = { week: null, month: 1, day: 6, type: 0, text: "The Epiphany" };
  ...
  it("normalizes Sunday from Luxon weekday 7 to 0 when matching propers", () => {
    ...
    const proper = { week: 6, month: null, day: 0, type: 1, text: "Romans 8:1-11" };
    const loader = new KeyLoader({ lectionary: [proper] });
  ...
  it("sorts week-based propers before month/day propers", () => {
    const weekProper = { week: 6, month: null, day: 0, type: 1, text: "Week-based" };
    const monthProper = { week: null, month: 1, day: 10, type: 1, text: "Month-based" };
