...
export class Week {
    ...
    getWeek() {
        ...
        const epiphany = toInternalDayjs(this.#year.getEpiphany(), "Year.getEpiphany()");
        const epiphanySunday = toInternalDayjs(this.#year.getEpiphanySunday(), "Year.getEpiphanySunday()");
        const transfiguration = toInternalDayjs(this.#year.getTransfiguration(), "Year.getTransfiguration()");
        const endOfYear = toInternalDayjs(this.#year.getEndOfYear(), "Year.getEndOfYear()");
        const lastSunday = toInternalDayjs(this.#year.getLastSunday(), "Year.getLastSunday()");
        ...
        else if (sunday.valueOf() >= transfiguration.valueOf() &&
