...
import { createLocalDate, getLegacyWeekday, toInternalDayjs, toPublicDate, } from "./date.js";
/**
...
export class Year extends BaseYear {
    ...
    getAdvent() {
        const christmas = toInternalDayjs(this.getChristmas(), "Year.getChristmas()");
    ...
    getEpiphanySunday() {
        ...
        return toPublicDate(epiphany.day() === 0 ? epiphany : epiphany.subtract(epiphany.day(), "day"));
    }
    getTransfiguration() {
