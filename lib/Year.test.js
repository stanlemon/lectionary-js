...
describe("Year", () => {
  ...
  it("getEpiphanySunday", () => {
    ...
    expect(new Year(2021).getEpiphanySunday().toISODate()).toEqual("2021-01-03");
    // Jan 6, 2019 is already a Sunday — returns Jan 6 itself
    expect(new Year(2019).getEpiphanySunday().toISODate()).toEqual("2019-01-06");
  });
  ...
  it("getAshWednesday", () => {
    // Lent minus 4 days
    expect(new Year(2021).getAshWednesday()).toEqual(DateTime.local(2021, 2, 17));
    expect(new Year(2022).getAshWednesday()).toEqual(DateTime.local(2022, 3, 2));
  });
  ...
  it("getLastSunday", () => {
    // Advent minus 1 week
    expect(new Year(2021).getLastSunday()).toEqual(DateTime.local(2021, 11, 21));
    expect(new Year(2019).getLastSunday()).toEqual(DateTime.local(2019, 11, 24));
  });
